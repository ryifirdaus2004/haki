    ...
    <div>
      ...
      <div class="login_wrapper">
        <div class="animate form login_form">
          ...
          <h2 style="font-size: 25px; font-weight: 600;color: #26b99a;">HAKICS</h2>
          <h2 style="font-size: 18px; font-weight: 200; color: #26b99a;">Sistem Informasi Ceket Menabung</h2>
            <form action="cek_login.php" method="post">
              <p>Masukkan Username dan Password</p>
              <br><center><p>Create by Moh. Zaenul Haki
